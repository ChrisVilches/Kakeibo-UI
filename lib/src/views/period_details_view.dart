...
class _PeriodDetailsState extends State<PeriodDetailsView> {
  ...
  bool providerHasDifferentPeriod() {
    ...
    return navigationCtrl.hasPeriod() &&
        (_period == null || _period!.id != navigationCtrl.currentPeriod!.id);
  }
  ...
  void didChangeDependencies() async {
    ...
    _period = Provider.of<NavigationController>(context, listen: false).currentPeriod!;
